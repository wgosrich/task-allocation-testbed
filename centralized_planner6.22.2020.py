...
class CentralizedPlanner():
    ...
    def plan(self):
        ...
        # compute how many iterations do we need
            ...
            agent_state = self.agent_state_reset(reset_col_ind[i2],n_agents,one_to_one_params.tasks)
...
#6.21.2020
# agent reset opt NO - for uneven (7,8...), it always assign the alst position to the first robot - Yes
# highr than 12 Yes
# 7,8... Yes
# tail problem
